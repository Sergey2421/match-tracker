    ...
    return (
        <svg width="48" height="49" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                stroke="url(#paint1_linear_72_662)" strokeWidth="2"/>
            <rect x="14" y="30.5" width="20" height="2" rx="0.4" fill="url(#paint2_linear_72_662)"/>
            <path
            ...
            <defs>
                <linearGradient id="paint0_linear_72_662" x1="24" y1="0.5" x2="24" y2="48.5"
                                gradientUnits="userSpaceOnUse">
                    <stop stopColor="#CF1C51"/>
                    <stop offset="1" stopColor="#AF1947"/>
                </linearGradient>
                <linearGradient id="paint1_linear_72_662" x1="24" y1="4.5" x2="24" y2="44.5"
                                gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FEE3A2"/>
                    <stop offset="1" stopColor="#F2A768"/>
                </linearGradient>
                <linearGradient id="paint2_linear_72_662" x1="24" y1="30.5" x2="24" y2="32.5"
                                gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FEE3A2"/>
                    <stop offset="1" stopColor="#F2A768"/>
                </linearGradient>
                <linearGradient id="paint3_linear_72_662" x1="24" y1="14.5" x2="24" y2="28.5"
                                gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FEE3A2"/>
                    <stop offset="1" stopColor="#F2A768"/>
                </linearGradient>
